...
ssh_lon_to_180_180_preproc_conf = pbuilds(apply_ssh_preproc, preproc_steps=("lon_to_180_180",))
ssh_preproc_store = store(group="ssh_preproc")
ssh_preproc_store(ssh_lon_to_180_180_preproc_conf, name="lon_to_180_180")
